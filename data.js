export const CONFIG = {
  CLIENT_ID: "Ov23ligGzK8hLcmDEbf5", // Your public OAuth Client ID (safe to expose)
  OAUTH_WORKER_URL: "https://wyte-oauth-worker.YOUR-SUBDOMAIN.workers.dev", // CHANGE THIS after deploying the worker
